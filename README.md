...
- If you experienced a bug, including the log files can significantly help in resolving the issue. See [here for how to find the logs](https://wiki.neos.com/index.php?title=Frequently_Asked_Questions#Where_can_I_find_log_files.3F).
...
- DON'T hijack existing issue for a similar, but different problem - we generally focus on the issue reported in the original post and won't address other issues mentioned in comment unless they're the same problem. Please make a separate issue instead.
- DO be specific - e.g. "It took roughly 10 minutes" or explain what exact problems and examples you found. Simply stating that there are problems or use-cases isn't enough.
- DO provide information on regressions when was the last time (at least approximately) the feature worked and how do you know that it worked before, so we can evaluate regressions properly
...
Please do not submit security exploits to the public GitHub. You can report them privately at on our [moderation](https://moderation.neos.com) portal.
...
If your issue directly relates to another user or group rather than a general bug or feature requests for the software, please make a ticket on our [moderation](https://moderation.neos.com) portal instead.
...
1. [Main Roadmap](https://github.com/Neos-Metaverse/NeosPublic/projects/1) - Overall larger ticket items, these move slower but that doesn't mean that we aren't working on them.
1. [Quality Control Teams's Priority/Triage Board](https://github.com/Neos-Metaverse/NeosPublic/projects/23) - A board for QC to triage, prioritize and organize community quality control issues.
1. [Desktop](https://github.com/Neos-Metaverse/NeosPublic/projects/3) - Anything relating to our Desktop Mode.
1. [UI Overhaul](https://github.com/Neos-Metaverse/NeosPublic/projects/2) - Everything to do with UI / UX, Including Dark Mode!
1. [Graphics](https://github.com/Neos-Metaverse/NeosPublic/projects/11) - Graphical things, Shiny things!
1. [Moderation / Security](https://github.com/Neos-Metaverse/NeosPublic/projects/16) - Moderation, security and permission related matters.

[There are others you can check](https://github.com/Neos-Metaverse/NeosPublic/projects).
...
- Vertices being randomly messed up, stretching where they shouldn’t (either with static model or when using blend shapes)
- Model failing to import at all or crashing Neos
- Fingers being mangled after avatar is equipped
